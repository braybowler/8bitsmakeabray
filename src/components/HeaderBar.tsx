...
const HeaderBar = () => {
    return (
        <header className="sticky top-0 w-full bg-slate-50 dark:bg-black border-b border-slate-200 dark:border-slate-600 p-2 sm:p-4 flex justify-between items-center shadow-8bit shadow-purple-400 dark:shadow-green-400 z-50">
